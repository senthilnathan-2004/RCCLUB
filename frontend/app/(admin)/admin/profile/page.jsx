...
import { Camera, Save, AlertCircle, CheckCircle, Eye, EyeOff, Lock, User, Mail } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const handleEmailChangeRequest = async (e) => {
    ...
    setIsLoading(true)
    try {
      const response = await api.requestEmailChange(emailChangeData)
      setSuccess(response.message || "Approval link sent to your current email.")
      ...
      <Tabs defaultValue="profile" className="space-y-6">
        <TabsList className="bg-secondary">
          ...
          <TabsTrigger
            ...
            className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
          >
            <Mail className="mr-2 h-4 w-4" /> Email Change
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="email-change">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle>Request Email Change</CardTitle>
              <CardDescription>
                A permission link will be sent to your current email. Approve it to apply the new email.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleEmailChangeRequest} className="space-y-4 max-w-md">
                <div className="space-y-2">
                ...
                <Button type="submit" disabled={isLoading}>
                  {isLoading ? "Requesting..." : "Send Approval Request"}
                </Button>
              </form>
            </CardContent>
          </Card>
